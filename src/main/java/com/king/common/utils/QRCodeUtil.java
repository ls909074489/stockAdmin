...
//        String fileName = new Random().nextInt(99999999) + "." + FORMAT.toLowerCase(); 
        String fileName = System.currentTimeMillis()+new Random().nextInt(9) + "." + FORMAT.toLowerCase();
...
//        QRCodeUtil.encode(text, null, "e:\\", true);  
        ...
        //含Logo，指定二维码图片名  
//        QRCodeUtil.encode(text, "d:\\csdn.jpg", "d:\\", "qrcode", true); 
        System.out.println(QRCodeUtil.encode(text, "d:\\qrcode\\", true));
    }  
}  