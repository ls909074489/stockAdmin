package com.king.modules.info.reject;
 ...
 */
@Controller
@RequestMapping(value = "/info/reject")
public class RejectController extends BaseController<UserEntity> {
	...
	public String listView(Model model) {
		...
		return "modules/info/reject/reject_list";
	}
	...
	public String addView(Model model, ServletRequest request) {
		...
		model.addAttribute("apiurl", ParameterUtil.getParamValue("apiurl", "http://app.weishiao.com:8080/qjb"));
		return "modules/info/reject/reject_add";
	}
	...
	public String editView(Model model, ServletRequest request, UserEntity entity) {
		...
		return "modules/info/reject/reject_edit";
	}
	...
	public String detailView(Model model, ServletRequest request, UserEntity entity) {
		model.addAttribute("apiurl", ParameterUtil.getParamValue("apiurl", "http://app.weishiao.com:8080/qjb"));
		model.addAttribute("uuid", request.getParameter("uuid"));
		return "modules/info/reject/reject_detail";
	}
	...
	public String toReject(Model model,String uuid,HttpServletRequest request) {
		...
		model.addAttribute("apiurl", ParameterUtil.getParamValue("apiurl", "http://app.weishiao.com:8080/qjb"));
		return "modules/info/reject/reject_set_reject";
	}
	 ...
	 * @return
	 */
	@RequestMapping("/toRework")
	public String toRework(Model model,String uuid,HttpServletRequest request) {
		model.addAttribute("uuid", uuid);
		model.addAttribute("apiurl", ParameterUtil.getParamValue("apiurl", "http://app.weishiao.com:8080/qjb"));
		return "modules/info/reject/reject_set_rework";
	}
