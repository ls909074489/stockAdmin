...
public class PropertyPath implements Iterable<PropertyPath> {
	...
	/**
	 * YY主要解决排序的字段不能包涵下划线的问题。例如字段aa_bb.
	 * 
	 * @param source
	 * @param type
	 * @return
	 */
	public static PropertyPath fromOrderby(String source, Class<?> type) {
		return fromOrderby(source, ClassTypeInformation.from(type));
	}
	...
	* YY主要解决排序的字段不能包涵下划线的问题。例如字段aa_bb.
	 ...
	 * @return
	 */
	public static PropertyPath fromOrderby(String source, TypeInformation<?> type) {
