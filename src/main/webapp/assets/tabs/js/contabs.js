$(function() {
	...
	function n() {
		...
		if ($(".J_menuTab").each(function() {
			...
			var linkhref = "?"; if(ihref.indexOf("?")>0){linkhref = "&";}
			var r = '<iframe class="J_iframe" style="min-height:'+ iframe_height + 'px" name="iframe' + a + '" width="100%" height="100%" src="' + ihref +linkhref+'node=' + a + '" frameborder="0" data-id="' + t + '" seamless></iframe>';
