...
<div class="page-content hide" id="yy-page-edit">
	<div class="row yy-toolbar">
		<button id="yy-btn-save" type="button">
			<i class="fa fa-save"></i> 保存
		</button>
		<button id="yy-btn-cancel" class="btn blue btn-sm" type="button">
			...
			<div class="row">
				...
				<table id="yy-table-list" class="yy-table">
					...
					<tbody id="entityTableBody">
						<tr>
							<td>
								<input type="text" name="colName" value="userName" class="inputChange" style="width: 49%;" class="form-control"/>
