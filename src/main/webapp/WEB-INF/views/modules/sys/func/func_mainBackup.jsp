...
<c:set var="actionserviceurl" value="${ctx}/sys/funcAction" />
<html>
<head>
<title>功能注册</title>
</head>
<body>
	...
	<div id="maindiv" class="ui-layout-center">
		...
		<div>
			<form id="yy-form-func" class="form-horizontal">
		...
		<%@include file="func_tab.jsp"%>
	</div>

	<%@include file="func_script.jsp"%>
	<%@include file="func_actionscript.jsp"%>
</body>
</html>