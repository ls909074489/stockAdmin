...
<body>
	<div class="container-fluid page-container page-content">
		<div class="yy-toolbar">
			<button id="yy-btn-rolegroup-sure" class="btn blue btn-sm">
		...
		<div class="page-area" id="yy-page-area-list">
			...
			<div id="treeRoleGroup" class="ztree"></div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			_zTree = $.fn.zTree.init($("#treeRoleGroup"), _treeSetting);
			//zTree的搜索事件绑定
			...
			//    }
			//});
			$("#yy-btn-rolegroup-sure").bind("click", function() {
