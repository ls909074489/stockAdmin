...
<div class="page-content" id="yy-page-list">
	...
	<div class="row yy-searchbar">
			...
			<div id="div_col2_filter" data-column="2">
				标题 <input type="text" name="" class="column_filter form-control input-sm" id="col2_filter">
			</div>			
		</div>
		<div class="col-md-3 form-inline">
			<div id="div_col3_filter" data-column="3">
				模版编码 <input type="text" name="" class="column_filter form-control input-sm" id="col3_filter">
			</div>			
		</div>
