	...
	<div id="yy-page" class="container-fluid page-container">
		<div class="page-content" id="yy-page-list">
			<div class="row yy-toolbar">
				<shiro:hasPermission name="materialAdd">
					<button id="yy-btn-add" class="btn blue btn-sm">
						<i class="fa fa-plus"></i> 新增
					</button>
				</shiro:hasPermission>
				<shiro:hasPermission name="materialDel">
				...
				<shiro:hasPermission name="materialImport">
					<span id="importSpan">
	...
	<script type="text/javascript">
		...
		var _tableCols = [{
				...
				render : function(data, type, full) {
					...
					+ "<shiro:hasPermission name='materialEdit'><button id='yy-btn-edit-row' class='btn btn-xs btn-info' data-rel='tooltip' title='编辑'><i class='fa fa-edit'></i></button></shiro:hasPermission>"
					+ "<shiro:hasPermission name='materialDel'><button id='yy-btn-remove-row' class='btn btn-xs btn-danger' data-rel='tooltip' title='删除'><i class='fa fa-trash-o'></i></button></shiro:hasPermission>"
					+ "</div>";
				},
				width : "80"
			},{
