...
<script type="text/javascript">
	...
	function addRow(oTable, nRow) {
		...
		jqTds[5].innerHTML = '<input type="text" class="form-control" name="keyLength"  value="' + aData.keyLength + '">';
		//jqTds[6].innerHTML = '<input type="checkbox" class="checkboxes"  name="isdefault" value="' + aData.isdefault + '">';
		jqTds[6].innerHTML = '<input type="text" class="form-control" name="description"  value="' + aData.description + '">';
		jqTds[7].innerHTML = '<input type="text" class="form-control" name="showorder"  value="' + aData.showorder + '">';
		//setRowStyle(nRow);
		_addList.push(nRow);
	}
