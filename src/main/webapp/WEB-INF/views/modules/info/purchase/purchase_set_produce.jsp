...
<body>
			...
			<form id="yy-form-edit" class="form-horizontal yy-form-edit">
				...
				<table style="width: 98%;text-align: center;">
					<tr>
						...
						<td>
							<input name="produceCount" type="text" class="form-control" value="">
						</td>
					</tr>			
				</table>
			</form>
	...
	<script type="text/javascript">
		...
		function validateForms(){
			validata = $('#yy-form-edit').validate({
				...
				rules : {
					...
					'model' : {required : true,number:true,digits:true,maxlength : 20},
		...
		function onSave(isClose) {
			...
			var posturl = "${apiurl}/order/produce";
			var opt = {
				url : posturl,
				type : "post",
				...
				error : function(XMLHttpRequest, textStatus, errorThrown) {
					window.parent.YYUI.promAlert("HTTP错误。");
					layer.close(editview);
				}
			}
