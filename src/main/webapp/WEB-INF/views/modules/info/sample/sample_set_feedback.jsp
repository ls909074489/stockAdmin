...
<body>
	...
	<div>
		<form id="yy-form-edit" class="form-horizontal yy-form-edit">
			<input name="sampleId" type="text" class="hide" value="${uuid}">
			<input name="uuid" type="text" class="hide" value="${uuid}">
			<table style="width: 98%;text-align: center;">
				<tr>
					<td style="width: 10%;height: 50px;color: red;">
						反馈结果
					</td>
					<td>
						<select name="result" onchange="changeResult(this);" class="form-control">
							<option></option>
				...
				<tr id="contentTrId" style="display: none;">
					<td style="width: 10%;">
						反馈内容
					</td>
					<td>
	...
	<script type="text/javascript">
		...
		function onSave(isClose) {
			...
			var posturl = "${apiurl}/sample/setCustomerResult";
			var opt = {
				url : posturl,
				type : "post",
