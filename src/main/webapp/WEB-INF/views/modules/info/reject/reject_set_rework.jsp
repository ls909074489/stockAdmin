		...
		<form id="yy-form-edit" class="form-horizontal yy-form-edit">
			...
			<table style="width: 98%;text-align: center;">
				<tr style="height: 50px;">
					...
					<td>
						<input name="reworkCount" type="text" class="form-control" value="">
					</td>
				</tr>
			</table>
		</form>
	...
	<script type="text/javascript">
		...
		function validateForms(){
			validata = $('#yy-form-edit').validate({
				onsubmit : true,
				rules : {
					'reworkCount' : {required : true,number:true,digits:true,maxlength : 20}
				}
			});
		}
		...
		function onSave(isClose) {
			...
			var posturl = "${apiurl}/order/rework";
			var opt = {
				url : posturl,
				type : "post",
